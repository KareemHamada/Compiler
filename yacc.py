...
from exequeries import *
from lexer import ds,fileType


# from r_dataSource import Read_DataSource as rData
# import numpy as np
# import pandas as pd
# from queris import  query 
...
#SELECT column1, column2 INTO newtable FROM oldtable WHERE condition;
    ...
    if(fileType == "csv"):
        exe_select(columns_name,datasource,join,whereCond,group_Col,having,order,limit)
    else:
        query = s
        exe_sqlite(query,ds)
...
#  INSERT INTO SalesRecords (Region,Country,ItemType,SalesChannel,OrderPriority,OrderDate,OrderID,ShipDate,UnitsSold,UnitPrice,UnitCost,TotalRevenue,TotalCost,TotalProfit) VALUES (suez,malaha,OfficeSupplies,Online,H,362016,517073523,3262016,2401,651,524,1563555,1260428,303126);
